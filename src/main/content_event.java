 ...
 * @author windows
 */
public class content_event extends javax.swing.JFrame {
koneksi kon;
    /**
    ...
    public content_event() {
        ...
        String tampil = "select*from content_id where kategori='event'";
        try{
    ...
    private void cariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cariMouseClicked
        ...
        DefaultTableModel data = new DefaultTableModel(null, header);
        tabel_campus.setModel(data);
        String tampil = "select * from content_id where id_konten like '%"+search.getText()+"%' and kategori='event'";
        try{
            Statement st = kon.con.createStatement();
            ResultSet rs = st.executeQuery(tampil);
            while(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(content_event.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
