 ...
 * @author windows
 */
public class content_journal extends javax.swing.JFrame {
koneksi kon;
    /**
     * Creates new form content_campus
     */
    public content_journal() {
        kon = new koneksi();
        initComponents();
        Object header[] = {"Kode Artikel", "Judul Artikel", "Likes", "Views"};
        DefaultTableModel data = new DefaultTableModel(null, header);
        tabel_campus.setModel(data);
        String tampil = "select*from content_id where kategori='journal'";
        try{
    ...
    private void initComponents() {
        ...
        title.setText("Kategori : Journal");
    ...
    private void cariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cariMouseClicked
        ...
        DefaultTableModel data = new DefaultTableModel(null, header);
        tabel_campus.setModel(data);
        String tampil = "select * from content_id where id_konten like '%"+search.getText()+"%' and kategori='journal'";
        try{
            Statement st = kon.con.createStatement();
            ResultSet rs = st.executeQuery(tampil);
            while(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(content_journal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
