 ...
 * @author windows
 */
public class edit_journal extends javax.swing.JFrame {
koneksi kon;
    /**
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Kategori: Campus");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(edit_journal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
