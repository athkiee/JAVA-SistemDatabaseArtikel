 ...
 * @author windows
 */
public class add_job extends javax.swing.JFrame {
koneksi kon;
    /**
    ...
    private void BT_addMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BT_addMouseClicked
        ...
        try{
            ...
            String regist = "insert into content_id (id_konten, title_id, kategori, isi, likes, views) values (id_konten, '"+title+"', 'job', '"+link+"', likes, views)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(add_job.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
