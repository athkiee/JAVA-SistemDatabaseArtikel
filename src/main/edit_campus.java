 ...
 * @author windows
 */
public class edit_campus extends javax.swing.JFrame {
koneksi kon;
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(edit_campus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
