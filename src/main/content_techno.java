 ...
 * @author windows
 */
public class content_techno extends javax.swing.JFrame {
koneksi kon;
    /**
     * Creates new form content_campus
     */
    public content_techno() {
        kon = new koneksi();
        initComponents();
        Object header[] = {"Kode Artikel", "Judul Artikel", "Likes", "Views"};
        DefaultTableModel data = new DefaultTableModel(null, header);
        tabel_campus.setModel(data);
        String tampil = "select*from content_id where kategori='techno'";
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(content_techno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
