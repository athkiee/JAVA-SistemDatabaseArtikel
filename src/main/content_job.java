 ...
 * @author windows
 */
public class content_job extends javax.swing.JFrame {
koneksi kon;
    /**
    ...
    public content_job() {
        ...
        String tampil = "select*from content_id where kategori='job'";
        try{
    ...
    private void cariMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cariMouseClicked
        ...
        DefaultTableModel data = new DefaultTableModel(null, header);
        tabel_campus.setModel(data);
        String tampil = "select * from content_id where id_konten like '%"+search.getText()+"%' and kategori='job'";
        try{
            Statement st = kon.con.createStatement();
            ResultSet rs = st.executeQuery(tampil);
            while(rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(content_job.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
