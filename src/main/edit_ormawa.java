 ...
 * @author windows
 */
public class edit_ormawa extends javax.swing.JFrame {
koneksi kon;
    /**
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Kategori: Ormawa");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(edit_ormawa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
