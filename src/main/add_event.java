...
koneksi kon;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Kategori: Event");
    ...
    private void BT_addMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BT_addMouseClicked
        ...
        try{
            ...
            String regist = "insert into content_id (id_konten, title_id, kategori, isi, likes, views) values (id_konten, '"+title+"', 'event', '"+link+"', likes, views)";
